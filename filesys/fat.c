...
fat_fs_init (void) {
    ...
    fat_fs->data_start = fat_fs->bs.fat_start + fat_fs->bs.fat_sectors;// data start : data 저장이 가능한 sector 시작점
}
